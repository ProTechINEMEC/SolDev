...
function DesempenoSection({ form }) {
  const compromisoSponsor = Form.useWatch(['desempeno', 'compromiso_sponsor'], form)

  return (
    <Card title="8. Control de Desempeño" style={{ marginBottom: 24 }}>
      <Divider orientation="left" orientationMargin={0}>
        <Text strong>8.1 Definición de Indicadores Propuestos</Text>
      </Divider>
      ...
      <Divider orientation="left" orientationMargin={0}>
        <Text strong>8.2 Plan de Medición</Text>
      </Divider>

      <Form.Item
        name={['desempeno', 'como_medir']}
        label="8.2.1 ¿Cómo se medirá cada indicador?"
      >
        <TextArea
          rows={3}
      ...
      <Form.Item
        ...
        label="8.2.2 ¿Qué herramientas se usarán?"
      >
      ...
      <Form.Item
        ...
        label="8.2.3 ¿Quién captura y registra los datos?"
      >
        <Input placeholder="Nombre o cargo del responsable de la medición" />
      </Form.Item>

      <Divider orientation="left" orientationMargin={0}>
        <Text strong>8.3 Responsabilidades del Sponsor</Text>
      </Divider>

      <Form.Item
        name={['desempeno', 'compromiso_sponsor']}
        label="8.3.1 ¿El sponsor se compromete a medir y reportar los KPIs?"
      >
        <Radio.Group>
      ...
      <Form.Item
        ...
        label="8.3.2 Comentarios adicionales"
      >
        <TextArea
          rows={2}
